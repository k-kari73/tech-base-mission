...
<html lang = "ja">
    <head>
        <meta charset = "UTF-8">
        <title>TEAM COMMUNITY：掲示板</title>
        <link rel="stylesheet" href="css/mystyle.css">
        <meta name="keywords" content="TEAM COMMUNITY,掲示板">
        <meta name="description" content="TEAM COMMUNITYの掲示板">
    ...
    <header>
    <div class="header-in">
    <a href="index.html" id="pagetop"><img src="image/relogo.png" width="300" height="56" alt="TEAM COMMUNITY"></a>
    <nav>
    <ul>
    <li><a href="index.html">トップ</a></li>
    <li><a href="point.html">Missionのポイント</a></li>
    <li><a href="kansu01.html">覚えておきたい関数</a></li>
    <li>掲示板</li>
    <li><a href="https://portal.tech-base.net/php/mypage">TECH-BASE マイページ</a></li>
    </ul>
    </nav>
    </div>
    </header>
